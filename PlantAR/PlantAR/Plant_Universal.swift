...
""",
        ...
        plantParts: [
            ...
            PlantPart(id: "disc_florets", name: "Disc Florets", scientificName: "Flores tubulosi", function: "Produce seeds in the flower centre", modelPartName: "DiscFlorets"),
            PlantPart(id: "stem", name: "Stem", scientificName: "Caulis", function: "Supports the flower head and transports water and nutrients", modelPartName: "Stem"),
            PlantPart(id: "leaves", name: "Leaves", scientificName: "Folia", function: "Photosynthesis and gas exchange", modelPartName: "Leaves"),
            PlantPart(id: "receptacle", name: "Receptacle", scientificName: "Receptaculum", function: "The base that holds all the florets together", modelPartName: "Root")
        ],
        funFacts: [
...
""",
    ...
    Plant(
        ...
        description: """
Mustard plants are fast-growing annual or biennial members of the Brassicaceae (cabbage) family. They are one of the oldest cultivated crops, used for food, oil, and spice across Asia, Europe, and Africa for over 5,000 years.

STRUCTURE: Mustard produces clusters of small, bright yellow four-petalled flowers arranged on upright stems. The leaves are broad, lobed, and slightly rough-textured. After flowering, the plant produces long narrow seed pods called siliques that split open to release tiny round seeds.

ROOT SYSTEM: Mustard develops a strong taproot that anchors the plant firmly and reaches deep into the soil for water and nutrients. Lateral roots branch from the taproot for additional nutrient absorption.

REPRODUCTION: Mustard is pollinated by bees and other insects attracted to its nectar-rich flowers. Each plant can produce hundreds of seed pods, making it a prolific self-seeder.

USES: Mustard seeds are ground to make mustard condiment. The leaves are eaten as a leafy green vegetable (mustard greens). The oil extracted from seeds is widely used in cooking across South Asia.
""",
        icon: "🌼",
        color: "#F4D03F",
        difficulty: 1,
        ...
        hasARModel: true,
        imageURL: nil,
        apiSearchName: "Brassica juncea mustard",
        nativeRegion: "Mediterranean and Central Asia",
        availability: .springOnly,
        modelName: "mustard",
        ...
        plantParts: [
            ...
            PlantPart(id: "mustard_leaves", name: "Leaves", scientificName: "Folia", function: "Photosynthesis and nutrient production; edible as mustard greens", modelPartName: "Leaves"),
            PlantPart(id: "mustard_stem", name: "Stem", scientificName: "Caulis", function: "Supports the plant and transports water and nutrients", modelPartName: "Stem"),
            PlantPart(id: "mustard_taproot", name: "Taproot", scientificName: "Radix", function: "Anchors the plant and absorbs water and minerals from deep soil", modelPartName: "Root"),
            PlantPart(id: "mustard_pods", name: "Seed Pods (Siliques)", scientificName: "Siliquae", function: "Contain and disperse mustard seeds for reproduction", modelPartName: nil)
        ],
        funFacts: [
            "Mustard is one of the world's oldest cultivated spice crops — over 5,000 years!",
            "A single mustard plant can produce over 1,000 tiny seeds.",
            "Mustard greens are packed with vitamins K, A, and C.",
            "In India, mustard oil is used for cooking, massage, and even hair care.",
            "The tiny mustard seed has inspired proverbs across many cultures about small beginnings."
        ],
        quizQuestions: [
            QuizQuestion(id: "mustard_q1", question: "What is the mustard plant's root type?", options: ["Fibrous", "Taproot", "Bulb", "Adventitious"], correctAnswerIndex: 1, explanation: "Mustard has a strong taproot that grows deep into the soil to anchor the plant and absorb water."),
            QuizQuestion(id: "mustard_q2", question: "What are mustard seed pods called?", options: ["Legumes", "Capsules", "Siliques", "Drupes"], correctAnswerIndex: 2, explanation: "Mustard seed pods are called siliques — long, narrow pods that split open when ripe to release seeds."),
            QuizQuestion(id: "mustard_q3", question: "How many petals does a mustard flower have?", options: ["3", "4", "5", "6"], correctAnswerIndex: 1, explanation: "Mustard flowers have 4 petals arranged in a cross shape — a hallmark of the Brassicaceae family.")
        ]
    )
]
